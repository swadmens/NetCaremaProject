...
- (UIDatePicker *)datePicker {
    if (!_datePicker) {
        _datePicker = [[UIDatePicker alloc]initWithFrame:CGRectMake(0, self.manager.kTopViewH + 0.5, kScreenWidth, self.manager.kPickerViewH)];
        ...
        //设置初始时间
        _datePicker.date = [self toDateWithDateString:_selectValue];
