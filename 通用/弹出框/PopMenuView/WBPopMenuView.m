...
- (instancetype) initWithFrame:(CGRect)frame
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        _backImageView = [[UIImageView alloc]initWithFrame:[self menuFrame]];
        _backImageView.image = UIImageWithFileName(@"index_popview_image");
...
//        self.tableView.transform = CGAffineTransformMakeScale(0.0001, 0.0001);
        ...
        [_backImageView addSubview:self.tableView];
        [self.tableView alignTop:@"5" leading:@"0" bottom:@"0" trailing:@"0" toView:_backImageView];
...
- (CGRect)menuFrame {
    CGFloat menuX = [UIScreen mainScreen].bounds.size.width - 114;
