...
-(instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _processView.backgroundColor = UIColorFromRGB(0x00f5ac,1);
        ...
        minimumView.backgroundColor = UIColorFromRGB(0X0ACCAC,1);
...
-(void)prepareDeletePart
{
    ...
    _deleteView.backgroundColor = UIColorFromRGB(0x10acc0,1);
