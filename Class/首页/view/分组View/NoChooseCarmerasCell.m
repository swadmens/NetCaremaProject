...
@interface NoChooseCarmerasSubCell : WWTableViewCell
...
@interface NoChooseCarmerasCell ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation NoChooseCarmerasCell
...
- (void)dosetup {
    ...
    subTitle.text = @"（请选择下方设备）";
    subTitle.textColor = kColorThirdTextColor;
    subTitle.font = [UIFont customBoldFontWithSize:kFontSizeEleven];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NoChooseCarmerasSubCell *cell = [tableView dequeueReusableCellWithIdentifier:[NoChooseCarmerasSubCell getCellIDStr] forIndexPath:indexPath];
...
{
    [self.delegate nosSelectIndexRow:indexPath.row withSection:indexPath.section];
}
...
@implementation NoChooseCarmerasSubCell
